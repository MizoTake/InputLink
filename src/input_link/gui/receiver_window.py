...
from PySide6.QtWidgets import (
    ...
    QFrame, QGroupBox, QGridLayout, QProgressBar, QListWidget,
    QListWidgetItem, QPushButton, QSpinBox, QCheckBox, QTextEdit
)
from PySide6.QtCore import Qt, QTimer, Signal, QSize
from PySide6.QtGui import QFont, QIcon, QPalette, QColor

from .main_window import ModernButton, StatusCard
...
class ReceiverWindow(QMainWindow):
    ...
    def _create_virtual_controllers_section(self, layout: QVBoxLayout):
        """Create virtual controllers section."""
        ...
        controllers_layout.setContentsMargins(16, 16, 16, 16)
        controllers_layout.setSpacing(8)
        
        # Create virtual controller cards
    ...
    def _create_settings_section(self, layout: QVBoxLayout):
        ...
        # Max controllers
        controllers_label = QLabel("Max Controllers:")
        controllers_label.setStyleSheet("color: #1D1D1F; font-size: 12px; font-weight: 600;")
        
        self.max_controllers_spin = QSpinBox()
        self.max_controllers_spin.setRange(1, 8)
        self.max_controllers_spin.setValue(4)
    ...
    def _update_controller_count(self, count: int):
        ...
        while len(self.virtual_controller_cards) < count:
            ...
            # Find the controllers group and add the card
            controllers_group = self.findChild(QGroupBox, "Virtual Controllers")
            if controllers_group:
                controllers_group.layout().addWidget(card)
