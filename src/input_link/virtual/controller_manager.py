...
from input_link.virtual.base import VirtualController, VirtualControllerFactory
...
class VirtualControllerManager:
    ...
    def __init__(
        self,
        max_controllers: Optional[int] = None,
        ...
        Args:
            max_controllers: Maximum number of virtual controllers (None = no limit)
    ...
    async def create_controller(self, controller_number: int, **kwargs) -> bool:
        ...
        if self.max_controllers is not None and len(self._controllers) >= self.max_controllers:
    ...
    async def update_controller_state(self, input_data: ControllerInputData) -> bool:
        ...
        if (controller_number not in self._controllers and
            ...
            (self.max_controllers is None or len(self._controllers) < self.max_controllers)):
