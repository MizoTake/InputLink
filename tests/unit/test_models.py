...
class TestControllerInputData:
    ...
    def test_controller_number_validation(self):
        ...
        # Controller numbers above 8 are now allowed (no upper limit)
        data = ControllerInputData(controller_number=9, controller_id="test")
        assert data.controller_number == 9
